                ...
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            ...
                            <h3 class="mt-3 fw-bold text-primary">Lupa Password</h3>
                        </div>
                        ...
                        <?php else: ?>
                            <p class="text-muted text-center mb-4">Masukkan email Anda dan kami akan mengirimkan tautan untuk mereset password.</p>
